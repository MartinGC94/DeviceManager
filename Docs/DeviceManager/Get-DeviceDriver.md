...
```
Get-DeviceDriver -Device <Device> [-IncludeAvailableDrivers] [-AllClassDrivers] [<CommonParameters>]
```

### FromPath

```
Get-DeviceDriver -Device <Device> -Path <string[]> [-Recurse] [-IncludeAvailableDrivers]
...
```
Get-DeviceDriver -Device <Device> -LiteralPath <string[]> [-Recurse] [-IncludeAvailableDrivers]
 [-AllClassDrivers] [<CommonParameters>]
```
